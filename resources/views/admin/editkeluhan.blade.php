...
<div class="mb-3">
    <label for="exampleFormControlInput1" class="form-label">Tanggapan Admin</label>
...
<div class="mb-3" id="tombol">
    ...
    <a type="button" class="btn btn-danger" href="{{ route('laporan-list', $keluhan->id) }}">Kembali</a>
</div>
</form>
@endsection