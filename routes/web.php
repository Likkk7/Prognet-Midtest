...
Route::prefix('pelaporan')->group(function () {
    ...
    Route::get('/keluhanbaru', [KeluhanController::class, 'keluhanbaru'])->name('keluhan-new')->middleware('auth');
    Route::post('/savenew', [KeluhanController::class, 'savekeluhanbaru'])->name('keluhan-save')->middleware('auth');
